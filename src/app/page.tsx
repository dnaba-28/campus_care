      ...
      <main className="flex-1">
        ...
        <div className="relative h-[450px] w-full">
          <Image
            ...
            className="z-0"
          />
          <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-gradient-to-b from-black/80 via-black/40 to-transparent text-center text-white">
